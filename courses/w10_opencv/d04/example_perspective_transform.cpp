...
int main(void) {
    string openPath = "../../../Data/Lane_Detection_Images/test.png";
	...
	src_pts.push_back(Point(886,444));
	src_pts.push_back(Point(908,457));
	src_pts.push_back(Point(908,444));
	src_pts.push_back(Point(886,457));
	...
	Mat roadPoint;
	drawCircle(roadColor, roadPoint, src_pts[0], 1, Scalar(255, 0, 0), -1);
	drawCircle(roadPoint, roadPoint, src_pts[1], 1, Scalar(0, 255, 0), -1);
	drawCircle(roadPoint, roadPoint, src_pts[2], 1, Scalar(0, 0, 255), -1);
	drawCircle(roadPoint, roadPoint, src_pts[3], 1, Scalar(255, 0, 255), -1);
