...
int main(void) {
	...
	Mat RECT, ELLIPSE, CROSS;
	imageMorphologyKernel(RECT, MORPH_RECT, 5);
    imageMorphologyKernel(ELLIPSE, MORPH_ELLIPSE, 5);
    imageMorphologyKernel(CROSS, MORPH_CROSS, 5);
	
	Mat roadGray_Open_RECT, roadGray_Close_RECT, roadGray_Gradient_RECT;
	
	imageMorphologyEx(roadThresh, roadGray_Open_RECT, MORPH_OPEN, RECT, 1);
	imageMorphologyEx(roadThresh, roadGray_Close_RECT, MORPH_CLOSE, RECT, 1);
	imageMorphologyEx(roadThresh, roadGray_Gradient_RECT, MORPH_GRADIENT, RECT, 1);
	...
	Mat roadGray_Open_ELLIPSE, roadGray_Close_ELLIPSE, roadGray_Gradient_ELLIPSE;
	
	imageMorphologyEx(roadThresh, roadGray_Open_ELLIPSE, MORPH_OPEN, ELLIPSE, 1);
	imageMorphologyEx(roadThresh, roadGray_Close_ELLIPSE, MORPH_CLOSE, ELLIPSE, 1);
	imageMorphologyEx(roadThresh, roadGray_Gradient_ELLIPSE, MORPH_GRADIENT, ELLIPSE, 1);
	...
	Mat roadGray_Open_CROSS, roadGray_Close_CROSS, roadGray_Gradient_CROSS;
	
	imageMorphologyEx(roadThresh, roadGray_Open_CROSS, MORPH_OPEN, RECT, 1);
	imageMorphologyEx(roadThresh, roadGray_Close_CROSS, MORPH_CLOSE, RECT, 1);
	imageMorphologyEx(roadThresh, roadGray_Gradient_CROSS, MORPH_GRADIENT, RECT, 1);
