...
int main(void) {
	...
	Mat roadCanny_100_200, roadCanny_50_100, roadCanny_75_150;
	
	cannyEdge(roadColor, roadCanny_50_100, 50, 100);
	cannyEdge(roadColor, roadCanny_75_150, 75, 150);
	cannyEdge(roadColor, roadCanny_100_200, 100, 200);
	
	imageShow("roadCanny_50_100", roadCanny_50_100);
	imageShow("roadCanny_75_150", roadCanny_75_150);
	imageShow("roadCanny_100_200", roadCanny_100_200);
