...
string roadVideo_03 = "ETS_H_01.mp4";
string roadVideo_04 = "PC_C_01.mp4";
string roadVideo_05 = "PC_C_02.mp4";
string roadVideo_06 = "PC_F_01.mp4";
string roadVideo_08 = "PC_H_01.mp4";
string roadVideo_10 = "PC_T_01.mp4";
...
int main(void) {
    ...
    string openPath3 = videopath + roadVideo_03;
    string openPath4 = videopath + roadVideo_04;
    string openPath5 = videopath + roadVideo_05;
    string openPath6 = videopath + roadVideo_06;
    string openPath8 = videopath + roadVideo_08;
    string openPath10 = videopath + roadVideo_10;
	...
	Video(openPath  , pts,"openPath1.avi");
    // Video(openPath3, pts3,"openPath3.avi");
    Video(openPath4 , pts4,"openPath4.avi");
    Video(openPath5 , pts5,"openPath5.avi");
    Video(openPath6 , pts6,"openPath6.avi");
    Video(openPath8 , pts8,"openPath8.avi");
    Video(openPath10, pts10,"openPath10.avi");
...
void Video(string openPath, vector<Point> pts, string savePath) {
...
void linefitting(Mat &image, Mat &result, vector<vector<Point> > &points) {
    ...
    drawText(result, result, "i wanna go home", Point(316, 284), FONT_HERSHEY_DUPLEX, 1, Scalar(255, 255, 255), 3);
    // drawText(result, result, "say, MIN JOON!", Point(316, 320), FONT_HERSHEY_DUPLEX, 1, Scalar(255, 255, 255), 3);
