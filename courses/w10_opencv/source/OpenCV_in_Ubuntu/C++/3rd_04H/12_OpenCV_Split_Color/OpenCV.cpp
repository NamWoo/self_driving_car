...
int main(void) {
	...
	splitColor(roadColor, output_white_hsv, lower_white_hsv, upper_white_hsv, COLOR_BGR2HSV);
	splitColor(roadColor, output_yellow_hsv, lower_yellow_hsv, upper_yellow_hsv, COLOR_BGR2HSV);
	Mat output_hsv = output_white_hsv+output_yellow_hsv;
	
	imageShow("output_white_hsv", output_white_hsv);
	imageShow("output_yellow_hsv", output_yellow_hsv);
	...
	splitColor(roadColor, output_white_hls, lower_white_hls, upper_white_hls, COLOR_BGR2HLS);
	splitColor(roadColor, output_yellow_hls, lower_yellow_hls, upper_yellow_hls, COLOR_BGR2HLS);
	Mat output_hls = output_white_hls+output_yellow_hls;
	
	imageShow("output_white_hls", output_white_hls);
	imageShow("output_yellow_hls", output_yellow_hls);
