...
void frameProcessing(Mat &frame, Mat &result) {
	...
	// splitColor(result, output_white_hsv, lower_white_hsv, upper_white_hsv, COLOR_BGR2HSV);
	// splitColor(result, output_yellow_hsv, lower_yellow_hsv, upper_yellow_hsv, COLOR_BGR2HSV);
    ...
    // Mat roadHLS;
    // convertColor(output_hls, result, COLOR_BGR2HLS);
