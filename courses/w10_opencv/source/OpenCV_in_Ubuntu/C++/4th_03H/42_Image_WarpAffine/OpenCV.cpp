...
int main(void) {
	...
	src_pts.push_back(Point(int(width*0.5), int(height*0.5)));
	...
	imageAffineTransformation(roadPoint, roadAffine_01, src_pts, dst_pts, Size());
	imageAffineTransformation(roadAffine_01, roadAffine_02, dst_pts, src_pts, Size());
	imageAffineTransformation(roadAffine_01, roadAffine_03, src_pts, dst_pts, Size(), WARP_INVERSE_MAP);	
