...
int main(void) {
	...
	Mat roadColor_Rotation_01, roadColor_Rotation_02, roadColor_Rotation_03;
	
	int width = roadColor.cols;
	int height = roadColor.rows;
	double angle = 15;
	double scale = 1.2;
	Point center(width*0.5, height*0.5);
	Size originSize(width, height);
	Size modSize(scale*width, scale*height);
	imageRotation(roadColor, roadColor_Rotation_01, center, angle, scale, modSize);
	imageRotation(roadColor_Rotation_01, roadColor_Rotation_02, center, -angle, 1.0/scale, originSize);
	imageRotation(roadColor_Rotation_01, roadColor_Rotation_03, center, angle, scale, originSize, WARP_INVERSE_MAP);
