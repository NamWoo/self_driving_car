...
int main(void) {
	...
	src_pts.push_back(Point(int(width*0.4), int(height*0.60)));
	...
	dst_pts.push_back(Point(int(width*0.05), 0));
	dst_pts.push_back(Point(int(width*0.9), 0));
	dst_pts.push_back(Point(int(width*0.9), height));
	dst_pts.push_back(Point(int(width*0.05), height));
	
	Mat roadPoint;
	drawCircle(roadColor, roadPoint, src_pts[0], 10, Scalar(255, 0, 0), -1);
	drawCircle(roadPoint, roadPoint, src_pts[1], 10, Scalar(0, 255, 0), -1);
	drawCircle(roadPoint, roadPoint, src_pts[2], 10, Scalar(0, 0, 255), -1);
	drawCircle(roadPoint, roadPoint, src_pts[3], 10, Scalar(255, 0, 255), -1);
