...
int main(void) {
	...
	Mat road_Resize_01, road_Resize_02, road_Resize_03;
	
	int width = roadColor.cols;
	int height = roadColor.rows;
	
	imageResize(roadColor, road_Resize_01, Size(width*0.5, height*0.5));
	imageResize(roadColor, road_Resize_02, Size(), 0.5, 0.5);
	imageResize(road_Resize_02, road_Resize_03, Size(), 2.0, 2.0);
	imageParameters("road_Resize_01", road_Resize_01);
	imageShow("road_Resize_01", road_Resize_01);
	imageParameters("road_Resize_02", road_Resize_02);
	imageShow("road_Resize_02", road_Resize_02);
	imageParameters("road_Resize_03", road_Resize_03);
	imageShow("road_Resize_03", road_Resize_03);
    destroyAllWindows();
    return 0;
}
