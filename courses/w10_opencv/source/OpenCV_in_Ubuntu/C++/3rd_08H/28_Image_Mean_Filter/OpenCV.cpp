...
int main(void) {
	...
	Mat meanblur, gaussianblur;
	
	imageBlur(roadColor, meanblur, 5);
	imageGaussianBlur(roadColor, gaussianblur, 5, 5, 0.0);
	imageShow("meanblur", meanblur);
	imageShow("gaussianblur", gaussianblur);	
