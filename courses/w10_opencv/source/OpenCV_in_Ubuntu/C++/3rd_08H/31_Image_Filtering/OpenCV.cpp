...
int main(void) {
	...
	Mat Laplacian_01, Laplacian_02;
	float LK01data[] = {0, -1, 0,
	                    -1, 5, -1,
	                    0, -1, 0};
	Mat LaplacianKernel_01(3, 3, CV_32F,LK01data);
	float LK02data[] = {1, -2, 1,
	                    -2, 5, -2,
	                    1, -2, 1};
	Mat LaplacianKernel_02(3, 3, CV_32F,LK02data);
	
	imageFiltering(roadColor, Laplacian_01, LaplacianKernel_01);
	imageFiltering(roadColor, Laplacian_02, LaplacianKernel_02);
	
	imageShow("Laplacian_01", Laplacian_01);
	imageShow("Laplacian_02", Laplacian_02);	
