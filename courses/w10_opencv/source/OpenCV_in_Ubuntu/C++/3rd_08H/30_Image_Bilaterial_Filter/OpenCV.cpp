...
int main(void) {
	...
	Mat Bilateral_5, Bilateral_10, Bilateral_20;
	
	imageBilateralFilter(roadColor, Bilateral_5, 5, 5, 5);
	imageBilateralFilter(roadColor, Bilateral_10, 10, 10, 10);
	imageBilateralFilter(roadColor, Bilateral_20, 20, 20, 20);
	imageShow("Bilateral_5", Bilateral_5);
	imageShow("Bilateral_10", Bilateral_10);
	imageShow("Bilateral_20", Bilateral_20);	
