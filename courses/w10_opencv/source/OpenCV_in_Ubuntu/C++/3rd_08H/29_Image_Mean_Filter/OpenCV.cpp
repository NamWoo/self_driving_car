...
int main(void) {
	...
	Mat medianblur_5, medianblur_9;
	
	imageMedianBlur(roadColor, medianblur_5, 5);
	imageMedianBlur(roadColor, medianblur_9, 9);
	imageShow("medianblur_5", medianblur_5);
	imageShow("medianblur_9", medianblur_9);	
