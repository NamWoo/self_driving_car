...
int main(void) {
	...
	Mat roadCircle_01, roadCircle_02, roadCircle_03;
	
	drawCircle(roadColor, roadCircle_01, pt1, 10, Scalar(255, 0, 0), -1);
	drawCircle(roadColor, roadCircle_02, pt2, 20, Scalar(0, 255, 0), 0);
	drawCircle(roadColor, roadCircle_03, pt3, 40, Scalar(0, 0, 255), 1);    

    imageShow("roadCircle_01", roadCircle_01);
    imageShow("roadCircle_02", roadCircle_02);
    imageShow("roadCircle_03", roadCircle_03);
