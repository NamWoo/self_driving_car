...
int main(void) {
	...
	Point pt1(int(width * 0.4), int(height * 0.6));
	Point pt2(int(width * 0.6), int(height * 0.6));
	Point pt3(int(width), height);
	Point pt4(0, height);
	Scalar Color(255,0,0);
	Mat roadLine;
	drawLine(roadColor, roadLine, pt1, pt2, Color, 5);
    drawLine(roadLine, roadLine, pt2, pt3, Color, 5);
    drawLine(roadLine, roadLine, pt3, pt4, Color, 5);
    drawLine(roadLine, roadLine, pt4, pt1, Color, 5);
