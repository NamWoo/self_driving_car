...
int main(void) {
	...
	Point pt1(0, int(height * 0.6));
	Point pt2(width, height);
	Rect rect(pt1, pt2);
	Scalar Color(255,0,0);
	Mat roadLine, roadRect_01, roadRect_02;
	drawLine(roadColor, roadLine, pt1, pt2, Color, 5);
    drawRect(roadColor, roadRect_01, pt1, pt2, Color, 5);
    drawRect(roadColor, roadRect_02, rect, Color, -1);

    imageShow("roadLine", roadLine);
    imageShow("roadRect_01", roadRect_01);
    imageShow("roadRect_02", roadRect_02);
