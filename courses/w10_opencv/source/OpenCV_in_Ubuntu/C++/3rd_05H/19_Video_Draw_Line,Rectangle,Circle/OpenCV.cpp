...
void frameProcessing(Mat &frame, Mat &result) {
    ...
    Mat roadLine;
    drawLine(result, result, pt1, pt2, Color1, 5);
    drawLine(result, result, pt2, pt3, Color1, 5);
    drawLine(result, result, pt3, pt4, Color1, 5);
    drawLine(result, result, pt4, pt1, Color1, 5);
    // imageShow("result1", result);

    //
    Point pt5(int(width * 0.5), int(height * 0.5));
    Point pt6(width, height);
    Point pt7(0, height);
    Scalar Color2(0,255,0);

    drawLine(result, result, pt5, pt6, Color2, 5);
    drawLine(result, result, pt6, pt7, Color2, 5);
    drawLine(result, result, pt7, pt5, Color2, 5);
    // imageShow("result2", result);

    ///
    Point pt8(0, 0);
    Point pt9(width, height);
	Rect rect(pt8, pt9);
    Scalar Color3(0,0,0);
    // Mat roadLine, roadRect_01, roadRect_02;
    // drawLine(roadColor, roadLine, pt1, pt2, Color3, 5);
    // drawRect(roadColor, roadRect_01, pt1, pt2, Color3, 5);
    drawRect(result, result, rect, Color3, 5);
    // imageShow("result3", result);

    ///
    Point pt10(int(width * 0.5), int(height * 0.5));
	drawCircle(result, result, pt10, 10, Scalar(255, 255, 255), -1);
    // imageShow("result4", result);
