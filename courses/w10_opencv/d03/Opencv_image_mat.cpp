...
int main(void) {
	string openPath_01 = imagepath + roadImage_06;
	string openPath_02 = imagepath + roadImage_04;
	string openPath_03 = imagepath + roadImage_01;
	
	Mat roadColor_01 = imageRead(openPath_01, IMREAD_COLOR);
	imageShow("roadColor_01", roadColor_01);
	Mat roadColor_02 = imageRead(openPath_02, IMREAD_COLOR);
	imageShow("roadColor_02", roadColor_02);
	Mat roadColor_03 = imageRead(openPath_03, IMREAD_COLOR);
	imageShow("roadColor_03", roadColor_03);
	
	Mat roadSum_01, roadSum_02, roadminus;
	addImage(roadColor_01, roadColor_02, roadSum_01);
    roadSum_02 = roadColor_01 + roadColor_02;
    roadminus = roadColor_01 - roadColor_03;
	imageShow("roadSum_01", roadSum_01);
	imageShow("roadSum_02", roadSum_02);
	imageShow("roadminus", roadminus);
