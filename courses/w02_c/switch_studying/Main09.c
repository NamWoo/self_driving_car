...
//	rGPFCON &= ~(0x03<<14);	//ready 00
	rGPFCON &= ~(0xffff);	//OUTPUT mode 01
	
//1	rGPFDAT &= ~(0x01<<7);	//GND, 해당 비트만 clear 0.	
...
int my_GET_SW(void)
{
	...
	if ((rGPFDAT & ~(0x7b)) == 0x00)			//GPF2
	{
		sw = 4;
	}
	else if ((rGPFDAT & ~(0x77)) == 0x00)	//GPF3
	{
		sw = 5;
	}
	else if ((rGPFDAT & ~(0x6f)) == 0x00)	//GPF4
	{
		sw = 6;
	}
	else if ((rGPFDAT & ~(0x5f)) == 0x00)	//GPF5
	{
		sw = 7;
	}
	else if ((rGPFDAT & ~(0x3f)) == 0x00)	//GPF6
	{
		sw = 8;
	}
	else 
	...
	if ((rGPFDAT & ~(0xfb)) == 0x0)			//GPF2
	{
		sw = 9;
	}
	else if ((rGPFDAT & ~(0xf7)) == 0x0)	//GPF3
	{
		sw = 10;
	}
	else if ((rGPFDAT & ~(0xef)) == 0x0)	//GPF4
	{
		sw = 11;
	}
	else if ((rGPFDAT & ~(0xdf)) == 0x0)	//GPF5
	{
		sw = 12;
	}
	else if ((rGPFDAT & ~(0xff)) == 0x0)	//GPF6
	{
		sw = 13;
	}
	else
