...
```
Helloooo my switch test
LED INIT rGPGCON : 40000000
LED INIT rGPGDAT : 8f0
LED INIT DONE
SW INIT done
KEY INIT rGPGCON : 40000001
KEY INIT rGPGDAT : 8f0
KEY INIT rGPFCON : 4000
KEY INIT rGPFDAT : 7f
KEY INIT DONE!LED ONOFF INIT rGPGDAT : 8f0
LED ONOFF set 0 LED ON rGPGDAT : 8f0
LED ONOFF set 1 LED OFF rGPGDAT : 8f0
```
...
int my_GET_SW(void)
{
	...
	if ((rGPFDAT & 0x7b) == 0x4)			//GPF2
	{
		sw = 4;
	}
	else if ((rGPFDAT & 0x77) == 0x8)	//GPF3
	{
		sw = 5;
	}
	else if ((rGPFDAT & 0x6f) == 0x10)	//GPF4
	{
		sw = 6;
	}
	else if ((rGPFDAT & 0x5f) == 0x20)	//GPF5
	{
		sw = 7;
	}
	else if ((rGPFDAT & 0x3f) == 0x40)	//GPF6
	{
		sw = 8;
	}
	else{}
...
[다시 # week2 index 로](../w02.md)

[다시 # 과정 main 으로](../../README.md)
