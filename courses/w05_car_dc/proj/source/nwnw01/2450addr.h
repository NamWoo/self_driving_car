...
#define rCAMDIVN    (*(volatile unsigned *)0x4c000018)	//USB, CAM Clock divider control    //EPLL Control
#define rEPLLCON    (*(volatile unsigned *)0x4c000018)	//USB, CAM Clock divider control    //EPLL Control
#define rCLKSRC    	(*(volatile unsigned *)0x4c000020)	//
#define rCLKDIV0    (*(volatile unsigned *)0x4c000024)	//Clock divider control
#define rCLKDIV1    (*(volatile unsigned *)0x4c000028)	//
#define rHCLKCON    (*(volatile unsigned *)0x4c000030)	//
#define rPCLKCON    (*(volatile unsigned *)0x4c000034)	//
#define rSCLKCON    (*(volatile unsigned *)0x4c000038)	//
...
#define rIISPSR  (*(volatile unsigned *)0x5500000c)	//IIS Prescaler
