...
void frameProcessing(Mat &frame, Mat &result) {
	...
	splitColor(frame, output_white_hls, lower_white_hls, upper_white_hls, COLOR_BGR2HLS);
	splitColor(frame, output_yellow_hls, lower_yellow_hls, upper_yellow_hls, COLOR_BGR2HLS);
