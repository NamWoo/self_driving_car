...
roadPoint = drawCircle(roadColor, tuple(src_pt1), 3, (255, 0, 0), -1)
roadPoint = drawCircle(roadPoint, tuple(src_pt2), 3, (0, 255, 0), -1)
roadPoint = drawCircle(roadPoint, tuple(src_pt3), 3, (0, 0, 255), -1)
roadPoint = drawCircle(roadPoint, tuple(src_pt4), 3, (255, 255, 0), -1)
